      ...
      <el-form :model="WANForm" label-position="left" size="small">
        <el-form-item label="选择功能" :label-width="formLabelWidth" v-loading="WANLANLoading">
          <el-select v-model="WANForm.use" placeholder="请选择内外网">
            <el-option :disabled="isInuseLAN" label="LAN（内网）" value="lan"></el-option>
            <el-option :disabled="isInuseWAN" label="WAN（外网）" value="wan"></el-option>
          </el-select>
        </el-form-item>
      </el-form>
...
<script>
  import { getPorts, sendSorting, sendWANLAN, sortingCancel } from '../../../../api/api.js'
