  ...
  <div>
    ...
    <el-col :span="24" class="col">
      <el-form :inline="true">
        ...
        <el-form-item>
          <el-button v-if="!proStatus" type="primary" @click="link">{{$t('operation.connect')}}</el-button>
          <el-button v-else type="primary" @click="unlink">{{$t('operation.disconnect')}}</el-button>
        </el-form-item>
        <el-form-item>
          <el-button type="danger" @click="stopWebSocketAll">关闭全部连接</el-button>
        </el-form-item>
        <el-form-item>
          <el-button v-if="!settingStatus" type="primary" @click="startWebSocket">启动动态路由配置</el-button>
          <el-button v-else type="danger" @click="stopWebSocket">关闭配置</el-button>
        </el-form-item>
      </el-form>
    </el-col>

    <div v-if="settingStatus" class="container">
