    ...
    <el-table :data="powerShow" :span-method="objectSpanMethod" border style="width: 100%; margin-top: 20px" :header-cell-style="headerStyle">
      ...
      <el-table-column property="operator" :label="$t('powerSetting.operator')" width="200">
        <template slot-scope="scope1">
          <el-switch on-text="是" off-text="否" on-color="#5B7BFA" off-color="#dadde5" v-model="scope1.row.operator" @change = change1(scope1.$index,scope1.row)>
          </el-switch>
        </template>
      </el-table-column>
      ...
      <el-table-column property="visitor" :label="$t('powerSetting.visitor')" width="200">
        <template slot-scope="scope2">
          <el-switch on-text="启用" off-text="禁用" on-color="#5B7BFA" off-color="#dadde5" v-model="scope2.row.visitor" @change = change2(scope2.$index,scope2.row)>
          </el-switch>
        </template>
      </el-table-column>
    </el-table>
